...
public class attach extends JFrame {
...
JButton btnGeri = new JButton("Geri");
		...
		lblNewLabel.setIcon(new ImageIcon(attach.class.getResource("/img/ust.png")));
		...
		Attach goster=new Attach();
		ResultSet gosterilcek;
		try {
			int yatay=12;
			int dikey=128;
			int sayac=1;
			gosterilcek = goster.viewAttach();
			while(gosterilcek.next()) {
				...
				JLabel lblM = new JLabel(gosterilcek.getString("AtName"));
				...
				label.setIcon(new ImageIcon(gosterilcek.getString("AtImgKucuk")));
