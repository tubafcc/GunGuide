...
public class mele extends JFrame {
...
JButton btnGeri = new JButton("");
		...
		lblNewLabel.setIcon(new ImageIcon(mele.class.getResource("/img/ust.png")));
		...
		Melee goster=new Melee();
		ResultSet gosterilcek;
		try {
			int yatay=12;
			int dikey=128;
			int sayac=1;
			gosterilcek = goster.viewMelee();
			while(gosterilcek.next()) {
				...
				JLabel lblM = new JLabel(gosterilcek.getString("MName"));
				...
				label.setIcon(new ImageIcon(gosterilcek.getString("MImgKucuk")));
